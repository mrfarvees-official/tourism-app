...
export default function CustomerDashboardCmsShell({ tenantKey, pageSlug = "customer-dashboard", children }: Props) {
  ...
  const resolvedTenantKey = tenantKey.trim();
  ...
  useEffect(() => {
    ...
    async function loadSchema() {
      setContentDatas([]);
      const next = await fetchTenantSchema(resolvedTenantKey);
      if (!active) return;
