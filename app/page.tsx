...
const destinations = [
  {
    ...
    price: "Live",
    highlight:
      "Create homepages, landing pages, and service pages without code.",
    icon: Mountain,
  },
  {
    name: "Booking Engine",
    ...
    price: "Live",
    highlight:
      "Collect inquiries, quote trips, and manage conversion-ready requests.",
    icon: Waves,
  },
  {
    name: "Tour Packages",
    ...
    price: "Live",
    highlight:
      "Publish packages, update inclusions, and keep itinerary content in sync.",
    icon: MapPinned,
  },
  {
    name: "Media Library",
    ...
    price: "Live",
    highlight:
      "Organize destination photos, banners, and content assets in one place.",
    icon: Compass,
  },
  {
    name: "Analytics",
    ...
    price: "Live",
    highlight:
      "See which destinations, pages, and offers generate the most engagement.",
    icon: Palmtree,
  },
];
...
const packages = [
  {
    ...
    price: "$49/mo",
    description:
      "For agencies that need a branded site, basic pages, and lead capture.",
  ...
  },
  {
    ...
    price: "$99/mo",
    description:
      "For teams managing multiple pages, packages, and content updates.",
  ...
  },
  {
    ...
    price: "$149/mo",
    description:
      "For agencies that want workflows, content publishing, and analytics.",
  ...
  },
  {
    ...
    price: "Custom",
    description:
      "For organizations running several travel brands or regional sites.",
...
const steps = [
  {
    ...
    description:
      "Start with a homepage, service pages, or a destination-focused landing page.",
  },
  {
    title: "Manage content",
    description:
      "Update tours, images, descriptions, and offers from the CMS dashboard.",
  },
  {
    title: "Track performance",
    description:
      "Monitor lead flow, page performance, and which packages convert best.",
  },
];
...
export default function Home() {
  return (
    <>
            ...
            <div className="grid gap-12 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
              <div className="max-w-3xl">
                <div className="inline-flex items-center gap-2 rounded-full border border-border bg-white/70 px-4 py-2 text-sm font-medium text-fg shadow-sm backdrop-blur">
                  ...
                  Built for tourism agencies that need one CMS to design and
                  manage their site.
                </div>

                <h1 className="mt-6 text-4xl font-semibold tracking-tight text-title sm:text-5xl lg:text-6xl">
                  Launch and manage tourism websites without rebuilding the same
                  pages twice.
                </h1>

                <p className="mt-5 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
                  This platform helps tourism agencies create branded websites,
                  publish travel packages, manage media, and keep content
                  updated from a single dashboard.
                </p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            Built for lead capture and client requests.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div className="rounded-2xl border border-border bg-slate-50 p-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-slate-500">
                            Content blocks agencies can reuse everywhere.
                          </p>
                        </div>
                      </div>
                    </div>
          ...
          <section id="destinations" className="py-16">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-semibold text-title sm:text-4xl">
                  Core platform modules
                </h2>
              </div>
              <p className="max-w-2xl text-sm leading-6 text-slate-600 sm:text-right">
                The homepage now explains the product clearly: agencies can
                build, manage, and grow their tourism websites from the same
                system.
              </p>
            </div>
              ...
              {destinations.map((destination) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-5 text-2xl font-semibold text-title">
                      {destination.name}
                    </h3>
                    ...
                    <div className="mt-5 flex items-center justify-between border-t border-border pt-4">
                      ...
                      <Link
                        href="/SignIn"
                        className="text-sm font-semibold text-primary transition group-hover:translate-x-0.5"
                      >
                        Manage module
                      </Link>
                    </div>
            ...
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="rounded-[2rem] border border-border bg-slate-900 p-8 text-white shadow-xl">
                ...
                <h2 className="mt-3 text-3xl font-semibold">
                  A cleaner way to go from idea to live website
                </h2>
                <p className="mt-4 max-w-xl text-sm leading-6 text-white/75">
                  Agencies can move from a blank canvas to a branded tourism
                  presence without juggling separate design, content, and lead
                  tools.
                </p>
            ...
            <div className="grid gap-8 rounded-[2rem] border border-border bg-gradient-to-br from-primary to-slate-900 p-8 text-white lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <p className="mt-4 max-w-2xl text-sm leading-6 text-white/75">
                  The page now speaks to agency owners, managers, and content
                  teams who need a system for websites, packages, and lead
                  management.
                </p>
              </div>
      ...
      <footer className="border-t border-border py-10 bg-slate-900">
        <div className="mx-12 grid gap-8 md:grid-cols-[1.2fr_0.8fr_0.8fr]">
          <div>
            <h3 className="text-xl font-semibold text-neutral-100">Tourism CMS</h3>
            <p className="mt-3 max-w-md text-sm leading-6 text-neutral-300">
              Build, manage, and grow tourism agency websites with pages,
              packages, media, inquiries, and analytics in one clean platform.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="mt-4 space-y-3 text-sm text-neutral-300">
              <a
                href="mailto:hello@tourismcms.com"
                className="block transition hover:text-primary"
              >
                hello@tourismcms.com
              </a>
        ...
        <div className="mt-8 border-t border-border pt-6 text-sm text-slate-500">
          <div className="mx-12 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-neutral-50">
            <p>
              © {new Date().getFullYear()} Tourism CMS. All rights reserved.
            </p>
